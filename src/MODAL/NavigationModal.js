        ...
        <ul>
          <li>
            <NavLink
              ...
              to="/shaanabrownnaeckler/über-mich"
          ...
          <li>
            <NavLink
              className={({ isActive }) => (isActive ? "active" : "inactive")}
              to="/shaanabrownnaeckler/meine-dienstleistungen"
              onClick={mobileNavigationHandler}
              end
            >
              {" "}
    ...
    <div>
      <React.Fragment>
        {ReactDOM.createPortal(
          <Background />,
          document.getElementById("blackdropRoot")
        )}
        {ReactDOM.createPortal(
          <NavigationModal />,
          document.getElementById("mobileNavigationRoot")
        )}
      </React.Fragment>
    </div>
  );
